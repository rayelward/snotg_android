...
public class XMPPClient extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		try {
			...
			Log.i("XMPPClient",
					"Failed to login as " + username + ": " + e.getMessage());
		}
			...
			public void onClick(View view) {
				...
				try {
					if (text != null) {
						...
						Log.i("XMPPClient", "Sent text [" + text + "] to ["
								+ to + "]");
					...
					Log.i("XMPPClient", "Failed Sending text [" + text
							+ "] to [" + to + "]:" + e.getMessage());
				}
	...
	public void getMessage(String incomingMSG, String from) {
		...
		if (incomingMSG != null) {
			...
			Log.i("XMPPClient", "Got text [" + incomingMSG + "] from ["
					+ fromName + "]");
